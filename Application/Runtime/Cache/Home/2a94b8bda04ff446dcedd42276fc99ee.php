...
<head>
    ...
    <!-- Hover Effects -->
    <link rel="stylesheet" href="/Public/css/set1.css">
    <!-- Main CSS -->
                ...
                <div class="find-place-img_wrap">
                    <div class="grid">
                        <figure class="effect-ruby">
                            <img src="/Public/images/find-place1.jpg" class="img-fluid" alt="img13"/>
                            <figcaption>
                                <h5>Nightlife </h5>
                                <p>385 Listings</p>
                            </figcaption>
                ...
                <div class="row find-img-align">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="/Public/images/find-place2.jpg" class="img-fluid" alt="img13"/>
                                    <figcaption>
                                        <h5>Restaurants</h5>
                                        <p>210 Listings</p>
                                    </figcaption>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="/Public/images/find-place3.jpg" class="img-fluid" alt="img13"/>
                                    <figcaption>
                                        <h5>Outdoors </h5>
                                        <p>114 Listings</p>
                                    </figcaption>
                ...
                <div class="row find-img-align">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="/Public/images/find-place4.jpg" class="img-fluid" alt="img13"/>
                                    <figcaption>
                                        <h5>Hotels </h5>
                                        <p>577 Listings</p>
                                    </figcaption>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="/Public/images/find-place5.jpg" class="img-fluid" alt="img13"/>
                                    <figcaption>
                                        <h5>Art & Culture </h5>
                                        <p>79 Listings</p>
                                    </figcaption>
        ...
        <div class="row">
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="/Public/images/featured1.jpg" class="img-fluid" alt="#">
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="/Public/images/featured2.jpg" class="img-fluid" alt="#">
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="/Public/images/featured3.jpg" class="img-fluid" alt="#">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    ...
                    <p>Copyright &copy; 2018 Listing. All rights reserved | made with Colorlib - More Templates <a
